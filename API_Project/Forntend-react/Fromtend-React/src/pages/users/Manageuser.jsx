...
const Manageuser = () => {
  ...
  const loaderUser = async()=>{ 
    const result= await axios.get("http://localhost/react/API_Project/Backend-api/view.php");
    setUser(result.data.phpresult);
    console.log(result.data.phpresult);
  };

  const handleDelete= async(id)=>{
    const res= await axios.delete("http://localhost/react/API_Project/Backend-api/delete.php?id="+ id);
